...
from callbacks.image_call_back_pseudo_healthy_semisupervised import ImageCallback_pseudo_healthy_semisup as ImageCallback
from sklearn.model_selection import train_test_split
from models.pseudo_healthy_semisupervised import pseudo_healthy_semisupervised

log = logging.getLogger("proposed_executor")

class pseudo_healthy_semisupervised_executor(Executor):
...
if __name__=='__main__':
    midl_model = pseudo_healthy_semisupervised(EasyDict(EXPERIMENT_PARAMS))
    midl_model.build()
    executor_midl_model = pseudo_healthy_semisupervised_executor(EasyDict(EXPERIMENT_PARAMS), midl_model)
