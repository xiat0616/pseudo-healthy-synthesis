...
class pseudo_healthy_semisupervised(BaseNet):
    '''
    Class of midl model;
    ...
    def build(self):
        ...
        self.gan_sup = Model(inputs=[cy1_I_p, cy2_I_h, cy2_M_h], outputs=[cy1_dis_I_pse_h, cy1_M_seg_d, cy1_I_rec_d, \
        ...
        self.gan_unsup = Model(inputs=[cy1_I_p, cy2_I_h, cy2_M_h], outputs=[cy1_dis_I_pse_h, cy1_dis_M_seg_d, cy1_I_rec_d, \
                                                             cy2_dis_I_pse_h, cy2_I_rec_h, cy2_M_rec_h])
...
if __name__=='__main__':
    ...
    midl_baseline_w_gan = pseudo_healthy_semisupervised(conf)
