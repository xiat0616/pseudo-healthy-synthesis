...
class pseudo_healthy_supervised(BaseNet):
    '''
    Class of midl model;
    ...
    def build(self):
        ...
        self.gan = Model(inputs=[cy1_I_p, cy2_I_h, cy2_M_h], outputs=[cy1_dis_I_pse_h, cy1_M_seg_d, cy1_I_rec_d, \
...
if __name__=='__main__':
    ...
    midl_baseline_w_gan = pseudo_healthy_supervised(conf)
